...
<nav class="navbar navbar-default navbar-static-top">
	...
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="dashboard.php">MPBD - Admin Panel</a>
	  </div>
...
?>><a href="menu_editor.php"><i class="fa fa-bars"></i> Menu Editor</a></li>
		  <li class="nav-header">Plants</li>
          <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'add_post.php') {
    echo 'class="active"';
}
?>><a href="add_post.php"><i class="fa fa-edit"></i> Add Plant</a></li>
		  <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'posts.php') {
    echo 'class="active"';
}
?>><a href="posts.php"><i class="fa fa-list"></i> Plants</a></li>


            <li class="nav-header">Dictionary</li>
            <li <?php
            if (basename($_SERVER['SCRIPT_NAME']) == 'botanies.php') {
                echo 'class="active"';
            }
            ?>><a href="botanies.php"><i class="fa fa-edit"></i> Botany</a></li>
            <li <?php
            if (basename($_SERVER['SCRIPT_NAME']) == 'pharmacologies.php') {
                echo 'class="active"';
            }
            ?>><a href="pharmacologies.php"><i class="fa fa-picture-o"></i> Pharmacology</a></li>
...
?>><a href="pages.php"><i class="fa fa-file-text-o"></i> Pages</a></li>
 ...
 <li class="nav-header">Contributors</li>
                        <li <?php
                        if (basename($_SERVER['SCRIPT_NAME']) == 'add_contributors.php') {
                            echo 'class="active"';
                        }
                        ?>><a href="add_contributors.php"><i class="fa fa-edit"></i> Add Contributor</a></li>
                        <li <?php
                        if (basename($_SERVER['SCRIPT_NAME']) == 'contributors.php') {
                            echo 'class="active"';
                        }
                        ?>><a href="contributors.php"><i class="fa fa-file-text-o"></i> Contributors</a></li>
